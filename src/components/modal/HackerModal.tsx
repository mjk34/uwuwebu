...
const BOOT_LINES: LineSpec[] = [
  ...
  { text: FINGERPRINT_LINE, slowFrom: FP_GAP_FROM, slowTo: FP_GAP_TO, slowMult: 40, pauseAfter: 150, tailFrom: FINGERPRINT_LINE.length - 1, tailClassName: "text-accent" },
  { text: "$ sudo ./enroll --provider=discord --scope=full", pauseAfter: 0 },
  { text: SPAWN_LINE, slowFrom: DOTS_FROM, slowTo: DOTS_TO, slowMult: 14, pauseAfter: 0, tailFrom: SPAWN_LINE.length - 2, tailClassName: "text-ok" },
  { text: "", pauseAfter: 150 },
  { text: "awaiting operator >>>", className: "text-[#ffb800]" },
];
